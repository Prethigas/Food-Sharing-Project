...
$qry=mysqli_query($conn,"insert into register(name,gender,age,email,phone,location,address,uname,psw,status) values('$name','$gender','$age','$email','$phone','$loc','$address','$uname','$psw','')");
	if($qry)
	{
...
<form method="post">
        <section class="dashboard" id="yourId">
                                    ...
                                    <div class="shopping-cart-new-address-from">
                                        ...
                                        <div class="shopping-cart-new-address-from-item">
                                            <div class="shopping-cart-new-address-from-inner">
                                                ...
                                                <input type="text" name="name" class="form-control" id="exampleFormControlInput11"
                                            ...
                                            <div class="shopping-cart-new-address-from-inner">
                                                ...
                                                <input type="text" name="age" class="form-control" id="exampleFormControlInput11"
                                        ...
                                        <div class="shopping-cart-new-address-from-item">
                                            <div class="shopping-cart-new-address-from-inner">
                                                ...
                                                <input type="email" name="email" class="form-control" id="exampleFormControlInput8"
                                                    placeholder="Email Address">
                                            </div>
                                            <div class="shopping-cart-new-address-from-inner">
                                                <label class="form-label">Phone</label>
                                                <input type="text" name="phone" class="form-control" id="exampleFormControlInput12"
                                                    placeholder="         ">
                                            </div>
                                        </div>
                                        <div class="shopping-cart-new-address-from-item">
                                            <div class="shopping-cart-new-address-from-inner">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlInput8" name="address"></textarea>
                                            </div>
                                            <div class="shopping-cart-new-address-from-inner">
                                                <label for="exampleFormControlInput1" class="form-label">Location</label>
                                                    <input type="text" class="form-control" name="loc" id="exampleFormControlInput12"
                                                    placeholder="Enter your location">                                            </div>
                                        </div>
                                        <div class="shopping-cart-new-address-from-item">
                                            <div class="shopping-cart-new-address-from-inner">
                                                <label for="exampleFormControlInput1" class="form-label">Username</label>
                                                <input type="text" class="form-control" name="uname" id="exampleFormControlInput12"
                                                    placeholder="Enter Username"> 
                                            </div>
                                            <div class="shopping-cart-new-address-from-inner">
                                                <label for="exampleFormControlInput1" class="form-label">Password</label>
                                                 <input type="text" class="form-control" name="psw" id="exampleFormControlInput12"
			...
			<input type="submit" value="register" class="main-btn-four" name='btn' >                             
                                               </div>
                                        </div>
                                    </div>
                                </div>
