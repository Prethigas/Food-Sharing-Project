                                    ...
                                    <div class="shopping-cart-new-address-from">
                                        ...
                                        <div class="shopping-cart-new-address-from-item">
                                            <div class="shopping-cart-new-address-from-inner">
                                                ...
                                                <input type="text" class="form-control" name="name" id="exampleFormControlInput11"
		...
		<div class="shopping-cart-new-address-from-inner">
                                        ...
                                        <div class="shopping-cart-new-address-from-item">
                                            <div class="shopping-cart-new-address-from-inner">
                                                ...
                                                <input type="email" class="form-control" name="email" id="exampleFormControlInput8"
                                                    placeholder="Email Address">
                                            </div>
                                            <div class="shopping-cart-new-address-from-inner">
                                                <label class="form-label">Phone</label>
                                                <input type="text" class="form-control" name="phone" id="exampleFormControlInput12"
                                                    placeholder="     ">
                                            </div>
                                        </div>
                                        <div class="shopping-cart-new-address-from-item">
