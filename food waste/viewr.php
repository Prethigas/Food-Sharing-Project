...
<body>
  ...
  <div class="nav-login-btn-main" >
	           ...
	           <a href="viewv.php" class="main-btn" >View Voluteers</a>
...
<tr>
		<td colspan="12" align="center"><strong>Food Available</strong></td>
  </tr>
<tr>
		<td colspan="10">&nbsp;</td>
  </tr>
		...
		<?php
		$qry=mysqli_query($conn,"select * from food where vid=''");
		$i=1;
			  ...
			  <td><div align="center"><?php echo $row['time'];?></div></td>
			   <td><div align="center"><?php echo $row['fname'];?></div></td>
				   ...
				   <td><div align="center"><?php echo $row['loc'];?></div></td>
				    <td><div align="center" ><a href="add.php?fid=<?php echo $row['id'];?>" style="padding:5px 10px;background:green;border-radius:5px;color:#FFFFFF;font-weight:700;">ASSIGN NOW</a></div>
		</td>
        </tr>
		 <tr>
		  	 	<td>&nbsp;</td>
...
<br><br>
<h1>Pickup Assigned Status </h1>
<table width="98%" align="center" >
<tr>
		<td colspan="12" align="center"><strong>Pickup Status</strong></td>
  </tr>
	<tr>
		<td colspan="10">&nbsp;</td>
  </tr>
          ...
          <td width="1%">&nbsp;</td>
          <td width="7%"><div align="center" class="style6"><strong>Id</strong> </div></td>
		     <td width="11%"><div align="center" class="style6"><strong> Volunteer ID</strong> </div></td>
		   <td width="11%"><div align="center" class="style6"><strong> Date</strong> </div></td>
		   <td width="11%"><div align="center" class="style6"><strong>Time</strong> </div></td>
		    <td width="11%"><div align="center" class="style6"><strong>Food Name</strong> </div></td>
			  <td width="9%"><div align="center" class="style6"><strong>Food Details</strong> </div></td>
		...
		<?php	
			$qry1=mysqli_query($conn,"select * from stt");
		$i=1;
		while($row1=mysqli_fetch_array($qry1))
		{
		$fid1=$row1['fid'];
		$qry=mysqli_query($conn,"select * from food where id='$fid1'");
		$i=1;
        ...
        <tr>
		 <td width="1%">&nbsp;</td>
		    <td><div align="center"><?php echo $row['id'];?></div></td>
		<td><div align="center"><?php echo $row1['vid'];?></div></td>
		   <td><div align="center"><?php echo $row['date'];?></div></td>
			  <td><div align="center"><?php echo $row['time'];?></div></td>
			   <td><div align="center"><?php echo $row['fname'];?></div></td>
				   <td><div align="center"><?php echo $row['des'];?></div></td>
