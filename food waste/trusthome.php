                    ...
                    <div class="col-lg-12">
                        <div class="nav-main">
                            <div class="nav-main">
                                ...
                                <a href="trusthome.php" class="main-btn" >Home</a>						
...
<tr>
		<td colspan="12" align="center"><strong>Help Request</strong></td>
</tr>
<tr>
		<td colspan="10">&nbsp;</td>
</tr>
          ...
          <td width="7%"><div align="center" class="style6"><strong>Id</strong> </div></td>
		   ...
		   <td width="11%"><div align="center" class="style6"><strong>Time</strong> </div></td>
		    <td width="11%"><div align="center" class="style6"><strong>Food Name</strong> </div></td>
			  <td width="9%"><div align="center" class="style6"><strong>Food Details</strong> </div></td>
			   <td width="10%"><div align="center" class="style6"><strong>Benefitors</strong> </div></td>
		...
		<?php
		$qry=mysqli_query($conn,"select * from food where vid='$tid' && st=''");
		$i=1;
        ...
        <tr>
		 <td width="1%">&nbsp;</td>
				   ...
				   <td><div align="center" style="display:flex;"><a href="accept.php?id=<?php echo $row['id'];?>" style="padding:5px 10px;background:green;border-radius:5px;color:#FFFFFF;font-weight:700;">Accept</a>/<a href="reject.php?id=<?php echo $row['id'];?>" style="padding:5px 10px;background:red;border-radius:5px;color:#FFFFFF;font-weight:700;">Reject</a></div>
		</td>
        </tr>
		 <tr>
		  	 	<td>&nbsp;</td>
...
<table width="98%" align="center" >
<tr>
		<td colspan="12" align="center"><strong>Accepted Request</strong></td>
</tr>
<tr>
		<td colspan="10">&nbsp;</td>
</tr>
		   ...
		   <td width="11%"><div align="center" class="style6"><strong>Time</strong> </div></td>
		    <td width="11%"><div align="center" class="style6"><strong>Food Name</strong> </div></td>
			  <td width="9%"><div align="center" class="style6"><strong>Food Details</strong> </div></td>
			   <td width="10%"><div align="center" class="style6"><strong>Benefitors</strong> </div></td>
			     <td width="10%"><div align="center" class="style6"><strong>Location</strong> </div></td>
				   <td width="10%"><div align="center" class="style6"><strong>Donar Contact</strong> </div></td>
        </tr>
		<tr>
		<td colspan="12">&nbsp;</td>
		</tr>
		<?php
		$qry=mysqli_query($conn,"select * from food where vid='$tid' && st='1'");
		$i=1;
		while($row=mysqli_fetch_array($qry))
		{
		$fid=$row['id'];
		$did=$row['did'];
		$qry1=mysqli_query($conn,"select * from register where id='$did'");
