...
<tr>
<td colspan="10" align="center"><strong>Volunteer Details</strong></td>
</tr>
	<tr>
	<td colspan="10">&nbsp;</td>
                     </tr>
		    <tr>
                                           <td width="1%">&nbsp;</td>	  
		    <td width="11%"><div align="center" class="style6"><strong>Donation Date</strong> </div></td>
		   <td width="11%"><div align="center" class="style6"><strong>Time</strong> </div></td>
		    ...
		    <td width="9%"><div align="center" class="style6"><strong>Food Quantity</strong> </div></td>
		   <td width="11%"><div align="center" class="style6"><strong>Volunteer Name</strong> </div></td>
	<td width="10%"><div align="center" class="style6"><strong>Contact No</strong> </div></td>
	<td width="10%"><div align="center" class="style6"><strong>Email</strong> </div></td>
                    <td width="1%">&nbsp;</td>
                                          </tr>
		<tr>
		<td colspan="12">&nbsp;</td>
		...
		<?php
		$qry2=mysqli_query($conn,"select * from food WHERE  did='$did' && st='1'");
		while($row2=mysqli_fetch_array($qry2)){
		$vid=$row2['vid'];
		$qry=mysqli_query($conn,"select * from tregister where id='$vid'");
		$i=1;
	$row=mysqli_fetch_array($qry);
		?>
        <tr>
		                    <td width="1%">&nbsp;</td>
			<td><div align="center"><?php echo $row2['date'];?></div></td>
			  <td><div align="center"><?php echo $row2['time'];?></div></td>
			  <td><div align="center"><?php echo $row2['fname'];?></div></td>
			  <td><div align="center"><?php echo $row2['qty'];?></div></td>
